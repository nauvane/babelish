...
An open-source editor like [Brackets](http://brackets.io) allows you to write and to edit documents in Markdown, and to preview the content as it would appear in print or on screen. 

{{< figure src="/images/brackets.png" caption="A Markdown file in Brackets with preview" alt="A Markdown file in Brackets" width="80%">}}
