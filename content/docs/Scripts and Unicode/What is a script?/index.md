...
The written word is pervasive and scripts are the basis on which we communicate in writing. With the publication of **[Unicode 13.0.0](http://www.unicode.org/versions/Unicode13.0.0/)** on 10 March 2020, the standard now supports [154 scripts](https://www.unicode.org/standard/supported.html). 
