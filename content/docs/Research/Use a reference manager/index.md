...
### Editing with Zotero: reproducing research references
 ...
 Once you install the Zotero Connector in Google Chrome, you will see a dedicated button appear on the menu bar: you can then insert a reference to an item. 
