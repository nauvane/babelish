...
The most widely used word-processor continues to be **Microsoft Word**, which is [a well-documented application](https://support.office.com/en-gb/word). 

You can also consider using **LibreOffice** for your work in languages for a number of reasons:
